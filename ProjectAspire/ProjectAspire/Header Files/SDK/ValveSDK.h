...
#define TICK_INTERVAL			(g_interfaces->Globals->m_interval_per_tick)
...
public:
	...
	float dist_to( const Vector2& v ) const
	{
		return ( *this - v ).length();
	}

	float dist_to_sqr( const Vector2& v ) const
	{
...
inline constexpr float RAD2DEG( const float x )
{
	return ( float )( x ) * ( float )( 180.f / M_PI_F );
}

inline constexpr float DEG2RAD( const float x )
{
...
public:
	...
	{
		return Vector3{ RAD2DEG( std::atan2( -z, std::hypot( x, y ) ) ), RAD2DEG( std::atan2( y, x ) ), 0.0f };
	}
	...
	float dist_sqr( const Vector3& v ) const
	{
	...
	float dot_2d( const Vector3& v ) const
	{
		return ( x * v.x + y * v.y );
	}
	...
	void normalize()
	{
		...
		for ( auto i = 0; i <= 2; i++ )
		{
			if ( vec[ i ] > 180.f || vec[ i ] < -180.f )
				vec[ i ] = ( vec[ i ] < 0.f ) ? vec[ i ] + 360.f * round( abs( vec[ i ] / 360.f ) )
				: vec[ i ] - 360.f * round( abs( vec[ i ] / 360.f ) );
		}
	}
...
public:
	...
	{
		return Memory::GetVirtual<c_client* ( __thiscall* )( void* ) >( this, 8 )( this );
	}

	inline bool DispatchUserMessage( int message_type, size_t v1, size_t length, const void* data = nullptr )
	{
		return Memory::GetVirtual<bool( __thiscall* )( void*, int, size_t, size_t, const void* )>( this, 38 )( this, message_type, v1, length, data );
	}
};
...
public:
	virtual void pad();
	virtual const Vector3& OBBMins() const;
	virtual const Vector3& OBBMaxs() const;

	const Vector3& collision_origin()
	{
		return *reinterpret_cast< Vector3* >( reinterpret_cast< uintptr_t >( this ) + 0x90 );
	}

	const Vector3& collision_angles()
	{
		return *reinterpret_cast< Vector3* >( reinterpret_cast< uintptr_t >( this ) + 0x9C );
	}

	Vector3 get_prescaled_mins();
	Vector3 get_prescaled_maxs();

	Vector3 mins()
	{
		using fn = Vector3 & ( __thiscall* )( void* );

		return Memory::GetVirtual<fn>( this, 1 )( this );
	}
	...
	Vector3 maxs()
	{
		...
		return Memory::GetVirtual<fn>( this, 2 )( this );
	}
};
...
public:
	inline IMaterial* find( const char* pMaterialName, const char* pTextureGroupName, bool complain = true, const char* pComplainPrefix = 0 )
	{
		...
		return Memory::GetVirtual<OriginalFn>( this, 84 )( this, pMaterialName, pTextureGroupName, complain, pComplainPrefix );
	}
	inline uint16_t FirstMaterial()
	{
		typedef uint16_t( __thiscall* oFirstMaterial )( void* );
		return Memory::GetVirtual<oFirstMaterial>( this, 86 )( this );
	}

	inline uint16_t NextMaterial( uint16_t h )
	{
		typedef uint16_t( __thiscall* oNextMaterial )( void*, uint16_t );
		return Memory::GetVirtual<oNextMaterial>( this, 87 )( this, h );
	}

	inline uint16_t InvalidMaterial()
	{
		typedef uint16_t( __thiscall* oInvalidMaterial )( void* );
		return Memory::GetVirtual<oInvalidMaterial>( this, 88 )( this );
	}

	IMaterial* get( uint16_t h )
	{
		typedef IMaterial* ( __thiscall* oGetMaterial )( void*, uint16_t );
		return Memory::GetVirtual<oGetMaterial>( this, 89 )( this, h );
	}
};
...
public:
	void ChatPrintf( int player_index, int filter, const char* fmt, ... )
	{
		...
		return Memory::GetVirtual< fn >( this, 26 )( this, player_index, filter, fmt );
	}
};
...
{
public:
	bool IsTakingSteamScreenshot()
	{
		return Memory::GetVirtual<bool( __thiscall* )( CEngineClient* )>( this, 92 )( this );
	}

	void ClientCmd( const char* command )
	{
		using fn = void( __thiscall* )( void*, const char* );
		return Memory::GetVirtual< fn >( this, 7 )( this, command );
	}

	bool GetPlayerInfo( int index, PlayerInfo_t* pInfo )
	{
		using fn = bool( __thiscall* )( void*, int, PlayerInfo_t* );
		return Memory::GetVirtual< fn >( this, 8 )( this, index, pInfo );
	}

	int GetPlayerForUserID( int UserID )
	{
		using fn = int( __thiscall* )( void*, int );
		return Memory::GetVirtual< fn >( this, 9 )( this, UserID );
	}

	int GetLocalPlayer()
	{
		using fn = int( __thiscall* )( void* );
		return Memory::GetVirtual< fn >( this, 12 )( this );
	}
	...
	Vector3 GetViewAngles()
	{
		...
		Memory::GetVirtual< fn >( this, 18 )( this, ang );

		return ang;
	}

	void SetViewAngles( const Vector3& ang )
	{
		using fn = void( __thiscall* )( void*, const Vector3& );
		return Memory::GetVirtual< fn >( this, 19 )( this, ang );
	}

	int GetMaxClients()
	{
		using fn = int( __thiscall* )( void* );
		return Memory::GetVirtual< fn >( this, 20 )( this );
	}

	bool IsInGame()
	{
		using fn = bool( __thiscall* )( void* );
		return Memory::GetVirtual<fn>( this, 26 )( this );
	}

	bool IsConnected()
	{
		using fn = bool( __thiscall* )( void* );
		return Memory::GetVirtual< fn >( this, 27 )( this );
	}

	const char* GetLevelName()
	{
		using fn = const char* ( __thiscall* )( void* );
		return Memory::GetVirtual< fn >( this, 52 )( this );
	}

	INetChannelInfo* GetNetChannelInfo()
	{
		using fn = INetChannelInfo * ( __thiscall* )( void* );
		return Memory::GetVirtual< fn >( this, 78 )( this );
	}
};
...
public:
	...
	VectorAligned( const Vector3& vec )
	{
		this->x = vec.x;
		this->y = vec.y;
		this->z = vec.z;
...
class Player;
class GameTrace : public c_base_trace
{
public:

	bool HitWorld() const;
	bool HitNonWorld() const;
...
public:
	...
	GameTrace() {}
	GameTrace( const GameTrace& vOther );
};
...
public:
	...
	virtual Player* GetClientEntity( int iEnt ) = 0;
	virtual Player* GetEntityFromHandle( ULONG hEnt ) = 0;
	virtual int NumberOfEntities( bool bIncludeNonNetworkable ) = 0;
	virtual int GetHighestIndex() = 0;
...
public:
	...
	{
		using fn = void( __thiscall* )( void*, const char* );
		return Memory::GetVirtual< fn >( this, 14 )( this, value );
	}

	inline void SetValue( float value )
	{
		using fn = void( __thiscall* )( void*, float );
		return Memory::GetVirtual< fn >( this, 15 )( this, value );
	}

	inline void SetValue( int value )
	{
		using fn = void( __thiscall* )( void*, int );
		return Memory::GetVirtual< fn >( this, 16 )( this, value );
	}

	inline void SetValue( clr_t value )
	{
		using fn = void( __thiscall* )( void*, clr_t );
		return Memory::GetVirtual< fn >( this, 17 )( this, value );
	}

	inline char* GetName()
	{
		using fn = char* ( __thiscall* )( void* );
		return Memory::GetVirtual< fn >( this, 5 )( this );
	}
	...
	{
		using fn = int( __thiscall* )( void* );
		return Memory::GetVirtual< fn >( this, 13 )( this );
	}
}; //Size=0x0048
...
public:
	...
	virtual void			CallGlobalChangeCallbacks( ICVar* var, const char* pOldString, float flOldValue ) = 0;
	...
	virtual void			QueueMaterialThreadSetValue( ICVar* pConVar, const char* pValue ) = 0;
	virtual void			QueueMaterialThreadSetValue( ICVar* pConVar, int nValue ) = 0;
	virtual void			QueueMaterialThreadSetValue( ICVar* pConVar, float flValue ) = 0;
	...
	// Gets all of the convars.
	// NOTE; This has been working since 2018, change is unlikely.
	inline ICVar* GetAllCommands()
	{
		return *reinterpret_cast< ICVar** >( ( uintptr_t )this + 0x30 );
	}

	// Get convar address via hash.
	inline ICVar* GetConVar( HashT hash )
	{
		auto commands = GetAllCommands();
		if ( !commands )
			return nullptr;

		for ( auto cur = commands; cur != nullptr; cur = cur->m_next )
		{
			if ( Hash::Fnv1a( cur->m_name ) == hash )
				return cur;
		}
...
struct ray_t
{
	...
	ray_t( const Vector3& start, const Vector3& end )
	{
		Init( start, end );
	}
	...
	void Init( const Vector3& start, const Vector3& end )
	{
		...
		m_Extents = Vector3( 0.f, 0.f, 0.f );
		m_pWorldAxisTransform = nullptr;
		m_IsRay = true;

		m_StartOffset = Vector3( 0.f, 0.f, 0.f );
		m_Start = start;
	}

	void Init( const Vector3& start, const Vector3& end, const Vector3& mins, const Vector3& maxs )
	{
		m_Delta = end - start;
...
{
	Vector3 plane;			// The plane of the brush side
	float planec;
...
{
public:
	explicit TraceFilter( Player* entity = nullptr, trace_type_t tracetype = TRACE_EVERYTHING )
	{
		m_filter = entity;
		m_type = tracetype;
	}

	virtual bool should_hit_entity( Player* entity, int mask )
	{
...
public:
	...
	virtual void	ClipRayToEntity( const ray_t& ray, unsigned int fMask, Player* pEnt, GameTrace* pTrace ) = 0;

	// Traces a ray against a particular entity
	virtual void	ClipRayToCollideable( const ray_t& ray, unsigned int fMask, ICollideable* pCollide, GameTrace* pTrace ) = 0;

	// A version that simply accepts a ray (can work as a traceline or tracehull)
	virtual void	TraceRay( const ray_t& Ray, uintptr_t Mask, TraceFilter* Filter, GameTrace* Trace ) = 0;
	...
	virtual void	TraceRayAgainstLeafAndEntityList( const ray_t& ray, ITraceListData* pTraceData, unsigned int fMask, TraceFilter* pTraceFilter, GameTrace* pTrace ) = 0;

	// A version that sweeps a collideable through the world
	// abs start + abs end represents the collision origins you want to sweep the collideable through
	// vecAngles represents the collision angles of the collideable during the sweep
	virtual void	SweepCollideable( ICollideable* pCollide, const Vector3& vecAbsStart, const Vector3& vecAbsEnd,
									  const Vector3& vecAngles, unsigned int fMask, TraceFilter* pTraceFilter, GameTrace* pTrace ) = 0;
	...
	virtual bool PointOutsideWorld( const Vector3& ptTest ) = 0; //Tests a point to see if it's outside any playable area
...
{
public:
	inline const char* GetPanelName( int panel )
	{
		return Memory::GetVirtual< const char* ( __thiscall* )( void*, int ) >( this, 36 )( this, panel );
	}

	inline void EnableKeyboardInput( int panel, bool state )
	{
		return Memory::GetVirtual< void( __thiscall* )( void*, int, bool ) >( this, 31 )( this, panel, state );
	}

	inline void EnableMouseInput( int panel, bool state )
	{
		return Memory::GetVirtual< void( __thiscall* )( void*, int, bool ) >( this, 32 )( this, panel, state );
	}
};
...
public:
	...
	virtual void AddTextOverlay( const Vector3& origin, float duration, const char* format, ... ) FMTFUNCTION( 4, 5 ) = 0;
	virtual void AddTextOverlay( const Vector3& origin, int line_offset, float duration, const char* format, ... ) FMTFUNCTION( 5, 6 ) = 0;
	...
	virtual int w2s( const Vector3& point, Vector3& screen ) = 0;
	virtual int w2s( float flXPos, float flYPos, Vector3& screen ) = 0;
	...
	virtual void AddTextOverlayRGB( const Vector3& origin, int line_offset, float duration, float r, float g, float b, float alpha, const char* format, ... ) FMTFUNCTION( 9, 10 ) = 0;
	virtual void AddTextOverlayRGB( const Vector3& origin, int line_offset, float duration, int r, int g, int b, int a, const char* format, ... ) FMTFUNCTION( 9, 10 ) = 0;
	...
	virtual void AddBoxOverlay2( const Vector3& origin, const Vector3& mins, const Vector3& max, Vector3 const& orientation, const clr_t& faceColor, const clr_t& edgeColor, float duration ) = 0;
	...
	inline bool world_to_screen( const Vector3& in, Vector3& out )
	{
		using fn = int( __thiscall* )( CDebugOverlay*, const Vector3&, Vector3& );

		int ret = Memory::GetVirtual<fn>( this, 13 )( this, in, out );
...
public:
	...
	virtual void SetViewTarget( const Vector3& target ) = 0;
	...
	virtual void AddDecal( ModelInstanceHandle_t handle, ray_t const& ray,
						   Vector3 const& decalUp, int decalIndex, int body, bool noPokeThru = false, int maxLODToDecal = 1 ) = 0;
...
{
	Vector3		m_vecVisOrigin;					// The point to to use as the viewpoint for area portal backface cull checks.
...
public:
	...
	virtual void ComputeTextureCoordinate( Vector3 const& worldPos, Vector2& texCoord ) = 0;
	virtual void ComputeLightmapCoordinate( Vector3 const& worldPos, Vector2& lightmapCoord ) = 0;
...
public:
	...
	virtual bool RenderBrushModelSurface( Player* pBaseEntity, IBrushSurface* pBrushSurface ) = 0;
};
class IVRenderView
{
public:
	...
	virtual void			GetVisibleFogVolume( const Vector3& eyePoint, VisibleFogVolumeInfo_t* pInfo ) = 0;
	...
	virtual void			DrawBrushModelShadowDepth( void* baseentity, model_t* model, const Vector3& origin, const Vector3& angles, int DepthMode ) = 0;
	...
	virtual void			DrawBrushModelEx( void* baseentity, model_t* model, const Vector3& origin, const Vector3& angles, int mode ) = 0;
};
...
public:
	...
	void SetHost( Player* ent )
	{
		return Memory::GetVirtual< void( __thiscall* )( void*, Player* ) >( this, 1 )( this, ent );
	}

	void UnkFunc()
	{
		return Memory::GetVirtual< void( __thiscall* )( void* ) >( this, 4 )( this );
	}
};
...
{
public:
	void SetupMove( Player* ent, CUserCmd* cmd, PlayerMovementHelper* move_helper, void* move_data )
	{
		return Memory::GetVirtual< void( __thiscall* )( void*, Player*, CUserCmd*, PlayerMovementHelper*, void* ) >( this, 20 )( this, ent, cmd, move_helper, move_data );
	}

	void FinishMove( Player* ent, CUserCmd* cmd, void* move_data )
	{
		return Memory::GetVirtual< void( __thiscall* )( void*, Player*, CUserCmd*, void* ) >( this, 21 )( this, ent, cmd, move_data );
	}
...
public:
	model_t* GetModel( int index )
	{
		...
		return Memory::GetVirtual< fn >( this, 1 )( this, index );
	}

	int GetModelIndex( const char* name )
	{
		using fn = int( __thiscall* )( void*, const char* );
		return Memory::GetVirtual< fn >( this, 2 )( this, name );
	}

	const char* GetModelName( const model_t* model )
	{
		using fn = const char* ( __thiscall* )( void*, const model_t* );
		return Memory::GetVirtual< fn >( this, 3 )( this, model );
	}
	...
	void GetModelMaterials( const model_t* model, int count, IMaterial** ppMaterial )
	{
		...
		return Memory::GetVirtual< fn >( this, 19 )( this, model, count, ppMaterial );
	}

	studiohdr_t* GetStudioModel( const model_t* model )
	{
		using fn = studiohdr_t * ( __thiscall* )( void*, const model_t* );
		return Memory::GetVirtual< fn >( this, 32 )( this, model );
	}
};
...
struct vertex
{
	...
	void init( float x, float y, const Vector2& coord = Vector2( 0, 0 ) )
	{
...
public:
	...
	public:
		...
		{
			m_color = Vector3( color.base().r(), color.base().g(), color.base().b() );
			m_alpha = 1.0f;
...
public:
	...
	{
		return Memory::GetVirtual< wchar_t* ( __thiscall* )( void*, const char* ) >( this, 11 )( this, unlocalized );
	}
};
...
public:
	...
	{
		return Memory::GetVirtual< void( __thiscall* )( void*, c_stencil_state& ) >( this, 127 )( this, state );
	}
};
...
public:
	...
	virtual bool	ShouldDrawEntity( Player* pEnt ) = 0;
	virtual bool	ShouldDrawLocalPlayer( Player* pPlayer ) = 0;
	...
	virtual VPanel* GetMessagePanel() = 0;
	...
	virtual void	ActivateInGameVGuiContext( VPanel* pPanel ) = 0;
...
// https://github.com/ValveSoftware/source-sdk-2013/blob/master/sp/src/public/engine/IEngineSound.h#L75
class IEngineSound
{
public:
